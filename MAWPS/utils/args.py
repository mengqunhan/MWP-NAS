...
def get_args():
    parser=ArgumentParser(description='MTree Solver')

    #Runtime Parameter
    parser.add_argument('--mode',type=str,dest='mode',default='train',help='train or test')
    parser.add_argument('--device',type=str,dest='device',default='cuda:6',help='device')
    parser.add_argument('--early_stop',type=int,dest='early_stop',default=2000,help='early stop')
    ...
    parser.add_argument('--epochs',type=int,dest='epochs',default=2000,help='train epochs')
    ...
    parser.add_argument('--lr', type=float, dest='lr', default=5e-5, help='learning rate')
    ...
    parser.add_argument('--train_file',type=str,dest='train_file',default='./datasets/mawps/mawps_5fold/processed/Fold_0/train_mawps_new_mwpss_fold_0.json',help='train file')
    parser.add_argument('--val_file',type=str,dest='val_file',default='./datasets/mawps/mawps_5fold/processed/Fold_0/test_mawps_new_mwpss_fold_0.json',help='val file')
    parser.add_argument('--test_file',type=str,dest='test_file',default='None',help='test file')
    ...
    parser.add_argument('--eval_cut_width',type=int,dest='eval_cut_width',default=5,help='eval cut width')

    #Encoder parameter
    parser.add_argument('--bert_model_name',type=str,dest='bert_model_name',default='bert-base-uncased',help='tokenizer')
    ...
    parser.add_argument('--model_folder',type=str,dest='model_folder',default='MTree_Solver_robert',help='model folder')
